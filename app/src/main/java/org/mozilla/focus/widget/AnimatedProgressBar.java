...
public class AnimatedProgressBar extends ProgressBar {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (getProgressDrawable() == null) {
            setProgressDrawable(getResources().getDrawable(R.drawable.photon_progressbar, getContext().getTheme()));
        }

        setProgressDrawable(buildDrawable(getProgressDrawable(), wrap, duration, resId));
